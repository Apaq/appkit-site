          ...
          <ResponsiveContainer>
            <div class="two-col">
              ...
              <ul class="list--unstyled list--icon">
                ...
                <li><app-icon name="checkmark"/> Security baked in</li>
        ...
        <section>
          <ResponsiveContainer>
            <div class="two-col">
              ...
              <div>
                <p>Appkit is build on Web Components standard, so yout apps work with any major framework or no framework at all.</p>
